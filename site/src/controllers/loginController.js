...
function testar(req, res) {
    console.log("ENTRAMOS NA loginController");
            ...
            .then(
                function (resultado) {
                    ...
                    if (resultado.length >= 1) {
                        ...
                        res.status(403).send("Ja existe um usuário com o mesmo email");
...
function cadastrar(req, res) {
    ...
    if (nome == undefined) {
        ...
        res.status(400).send("Sua escolha está undefined!")
            ...
            loginModel.cadastrar(nome, email, senha, escolha)
                .then(
                    function (resultado) {
                        res.json(resultado);
                    }
